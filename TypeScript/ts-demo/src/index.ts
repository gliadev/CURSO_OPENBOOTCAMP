...
console.log("Hola Adolfo");
console.log("Adiós Adolfo");


// Declaración de Variables:
var nombre: string = 'Adolfo';
...
var apellidos: any = "Goemz"; // Tipo any hace que la variable pueda cambiar de tipo
apellidos = 3;
 ...
 * @param nombre Nombre de la persona a despedir, por defecto será "Patata"
 */
function despedirPersona(nombre: string = "Patata"){
